...
},mode:"extended",selected:null,updating:0,selectedIndex:-1,rangeStartIndex:-1,setMode:function(_2){
...
if(!_1e||this.rangeStartIndex<0){
this.rangeStartIndex=_1c;
}
if(!_1d){
this.deselectAll(_1c);
}
if(_1e){
this.selectRange(this.rangeStartIndex,_1c);
}else{
if(_1d){
