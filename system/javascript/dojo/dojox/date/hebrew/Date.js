...
var _1e=(!isNaN(_1d))?this._computeHebrewFields(_1d):NaN;
this._year=(!isNaN(_1d))?_1e[0]:NaN;
this._month=(!isNaN(_1d))?_1e[1]:NaN;
this._date=(!isNaN(_1d))?_1e[2]:NaN;
...
var _27=this._year||0,_28=this._month||0,_29=this._date||0,day=this._startOfYear(_27);
if(_28!=0){
