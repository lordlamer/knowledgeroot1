...
return function (App $app) {
    ...
    // HTML Routes (Backend Rendering)
    $app->get('/content/{id:\d+}', [ContentController::class, 'show'])->setName('content.show');
    $app->get('/category/{categoryId:\d+}', [ContentController::class, 'listByCategory'])->setName('content.list');
    $app->get('/category/{id:\d+}', [CategoryController::class, 'show'])->setName('category.show');
