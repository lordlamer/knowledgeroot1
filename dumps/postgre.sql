...
INSERT INTO settings (name, value, description, selection) VALUES ('htmleditor.editor', 'ckeditor', 'choose ckeditor or tinymce', '');
...
INSERT INTO settings (name, value, description, selection) VALUES ('htmleditor.ckeditor.width', '600', 'set widht of ckeditor', '');
INSERT INTO settings (name, value, description, selection) VALUES ('htmleditor.ckeditor.height', '450', 'set height of ckeditor', '');
INSERT INTO settings (name, value, description, selection) VALUES ('htmleditor.ckeditor.langdefault', 'en', 'set default lang in default ckeditor', '');
INSERT INTO settings (name, value, description, selection) VALUES ('htmleditor.ckeditor.langdetect', 'false', 'enable autodetection of language in ckeditor', '');
INSERT INTO settings (name, value, description, selection) VALUES ('htmleditor.ckeditor.toolbar', 'Default', 'choose toolbar in ckeditor', '');
INSERT INTO settings (name, value, description, selection) VALUES ('htmleditor.ckeditor.skin', 'default', 'choose skin in ckeditor', '');
